...
{
    public abstract class L11_DemoAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static L11_DemoAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(L11_DemoAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<L11_DemoAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<L11_DemoAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<L11_DemoAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<L11_DemoAppDbContext, Task<T>> func)
        {
            T result;
